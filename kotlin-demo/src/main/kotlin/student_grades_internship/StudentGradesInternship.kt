package student_grades_internship
...
fun List<StudentGrades>.getBestForScholarship(
    semester: String
): List<StudentGrades> = this.filter { studentGrades -> studentGrades.grades.filter { it.semester == semester && it.passing }.sumOf { it.ects } > 30 }
